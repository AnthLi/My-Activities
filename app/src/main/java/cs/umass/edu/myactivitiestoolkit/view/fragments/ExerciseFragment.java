...
/**
 * Fragment which visualizes the 3-axis accelerometer signal, displays the step
 * count estimates and current activity to the user and allows the user to
 * interact with the {@link AccelerometerService}.
 * <br><br>
 * <p>
 ...
 * and send the data to the server. The framework is there for you; you only
 * need to make the calls in the {@link AccelerometerService} to communicate the
 * data.
 * <br><br>
 * <p>
...
public class ExerciseFragment extends Fragment {
  ...
  /**
   * Displays the step count computed by your server-side step detection
   * algorithm.
   **/
  private TextView txtServerStepCount;

  /**
   * Displays the activity identified by your server-side activity
  ...
  /**
   * The series formatter that defines how the x-axis signal should be
   * displayed.
   **/
  private LineAndPointFormatter mXSeriesFormatter;

  /**
   * The series formatter that defines how the y-axis signal should be
   * displayed.
   **/
  private LineAndPointFormatter mYSeriesFormatter;

  /**
   * The series formatter that defines how the z-axis signal should be
   * displayed.
   **/
  ...
  /**
   * The number of points displayed on the plot. This should only ever be less
   * than {@link #GRAPH_CAPACITY} before the plot is fully populated.
   **/
  ...
  /**
   * The receiver listens for messages from the {@link AccelerometerService},
   * e.g. was the service started/stopped, and updates the status views
   * accordingly. It also listens for sensor data and displays the sensor
   * readings to the user.
   * <p>
   * In Assignment 1 (Step detection), you should listen for intent actions
   * indicating that a step was taken, as predicted by your server side
   * algorithm. We already do this for the built-in and local step detection
   * algorithms. You may display the step count in {@link #txtServerStepCount}.
   */
  private final BroadcastReceiver receiver = new BroadcastReceiver() {
    @Override
    public void onReceive(Context context, Intent intent) {
      // TODO: (Assignment 1) Display the step count as predicted by your
      // server-side algorithm, when a step event occurs
  ...
  /**
   * Displays the step count as computed by the server
   *
   * @param stepCount the number of steps taken since the service started
   */
